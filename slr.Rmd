...
* plot hist of resids
* plot fitted vs true
* t-value, p-value, std.error is estimate's precision
* R-squared
...
1. Multiple regression with continuous vars
    1. income ~ age is not linear
1. Categorical vars: dummies and interactions
